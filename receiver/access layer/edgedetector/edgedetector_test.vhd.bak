...
COMPONENT edgedetector  -- component declaratie
	PORT
	(
		clk     : IN std_logic;
		clk_en  : IN std_logic;
...
FOR uut : edgedetector USE ENTITY work.edgedetector(behavior); -- signalen aanmaken die overeenkomen met de poorten
